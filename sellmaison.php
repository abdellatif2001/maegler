...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->maison_reviews($title,$descrip,$price,$nb_chambre,$nb_salle_bain,$nb_sallon,$surface,$nb_etage,$id,$image,$location,$likes,$status);
        ...
        <div class="appart-info">
            ...
            <form action="" method="post" enctype='multipart/form-data'>
                ...
                <select name="nb_sallon" id="" class="form-control shadow-none">
                    <option value="-1">Nombre De Sallon</option>
                    <option value="0">1</option>
                    <option value="1">2</option>
                    <option value="2">3</option>
                </select>
                ...
                <input type="number" name="nb_etage" class="form-control shadow-none" placeholder="Nombre d'Etage" required>
