...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->clothe_reviews($title,$descrip,$price,$etat,$gender,$id,$image,$location,$likes,$status);
        ...
        <div class="appart-info">
            ...
            <form action="" method='post' enctype='multipart/form-data'>
                ...
                <div class="gender">
                    ...
                    <input type="radio" name="gender" required class="male" value='male'> Male &nbsp;&nbsp;
                    <input type="radio" name="gender" required class="female" value='female'> Female &nbsp;&nbsp;
                </div>
