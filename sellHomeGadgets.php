...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->gadget_reviews($title,$type,$price,$etat,$descrip,$id,$image,$location,$likes,$status);
        ...
        <div class="appart-info">
            ...
            <form action="" method="post" enctype='multipart/form-data'>
                ...
                <div class="mul-img">
                    ...
                    <input type="file" name="image[]" id="mul-img">    
                </div>
                ...
                <input type="text" name="type" class="form-control shadow-none" placeholder="Type" required>
