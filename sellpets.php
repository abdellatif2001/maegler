...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->pets_reviews($title,$descrip,$price,$etat,$gender,$id,$image,$location,$likes,$status);
...
<?php include('_navbar.php')?>
    <div class="container">
        <div class="appart-info">
            <h1 class="text-capitalize text-center">informations générale</h1>
            <hr>
            <form action="" method="post" enctype='multipart/form-data'>
                <input type="text" name="title" class="form-control shadow-none" placeholder="Titre" required>
                <input type="text" name="price" class="form-control shadow-none" placeholder="Prix" required>
                <div class="mul-img">
                ...
                <input type="text" name="etat" class="form-control shadow-none" placeholder="type" required>
                <div class="gender">
                    <p class="text-capitalize">le genre :</p>
                    <input type="radio" name="gender" value='male' required class="male"> Male &nbsp;&nbsp;
                    <input type="radio" name="gender"  value='female'required class="female"> Female &nbsp;&nbsp;
                </div>
