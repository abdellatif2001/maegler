...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->bike_reviews($title,$descrip,$price,$marque,$etat,$id,$image,$location,$likes,$status);
    ...
    <div class="container">
        <div class="appart-info">
            ...
            <form action="" method="post" enctype='multipart/form-data'>
                ...
                <input type="text" name="marque" class="form-control shadow-none" placeholder="Marque" required>
