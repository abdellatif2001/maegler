...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->shoes_reviews($title,$descrip,$price,$etat,$taille,$gender,$id,$image,$location,$likes,$status);
    ...
    <div class="container">
        <div class="appart-info">
            ...
            <form action="" method="post" enctype='multipart/form-data'>
                ...
                <select name="taille" id="" class="form-control shadow-none">
                ...
                <div class="gender">
                    <p class="text-capitalize">selectionner le genre :</p>
