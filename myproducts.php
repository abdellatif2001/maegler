    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Code Here -->
                <!-- Start Products -->
                <div class="myproduct" id="products">
                    <div class="approved">
                        <table class="table table-dark table-striped">
                            ...
                            <?php  foreach($tables_reviews as $table){
                                if (isset($products[$table])) {foreach($products[$table] as $product){?>    
                            <tr>
                                <td class="text-capitalize"><?=$product['title']?></td>
                                <td class="text-capitalize"><?=$product['price']?> DH</td>
                                <td class="text-capitalize"><?=$product['location']?></td>
                                <?php if($product['status'] == 'Approved') {?> 
                                    <td class="text-capitalize text-success">Approved</td>
                                <?php }elseif($product['status'] == 'pending') {?> 
                                    <td class="text-capitalize text-warning">pending</td>
                                <?php }else {?> 
                                    <td class="text-capitalize text-danger">rejected</td>
                                <?php } ?>  
                            </tr>
                            <?php }}}?> 
                        </table>
