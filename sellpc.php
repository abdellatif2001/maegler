...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->pc_reviews($title,$descrip,$price,$marque,$proce,$graphic,$etat,$ram,$capacity,$id,$image,$location,$likes,$status);
    ...
    <div class="container">
        <div class="appart-info">
            ...
            <form action="" method="post"enctype='multipart/form-data'>
                ...
                <input name="marque" type ="text" id="" class="form-control shadow-none" placeholder="Marque">
                <input name="proce" type ="text" id="" class="form-control shadow-none" placeholder="Processeur">
                <input name="graphic" type ="text" id="" class="form-control shadow-none" placeholder="Graphics">
                <input name="ram" type ="number" id="" class="form-control shadow-none" placeholder="Ram">
                <input name="capacity" type ="number" id="" class="form-control shadow-none" placeholder="stockage">
