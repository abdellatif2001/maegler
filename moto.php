              ...
              <div class="img-gallery">
                  ...
                  <div class="prod-content">
                    ...
                    <table class="table table-light">
                      ...
                      <tr>
                        <td class="text-capitalize">cylindre</th>
                        <td class="text-capitalize text-right"><?=$row['cyln']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">nombre de roues</th>
                        <td class="text-capitalize text-right"><?=$row['nb_whell']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">kilométrage</th>
                        <td class="text-capitalize text-right"><?=$row['klm']?> KM</td>
                      </tr>
                      <tr>
