...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->appartement_reviews($title,$descrip,$price,$nb_chambre,$nb_salle_bain,$nb_sallon,$surface,$etage,$id,$image,$location,$likes,$status);
    ...
    <div class="container">
        <div class="appart-info">
            ...
            <form action="" method="post"  enctype='multipart/form-data'>
                ...
                <select name="nb_chambre" id="" class="form-control shadow-none">
                    <option value="0">Selectionner Nombre De Chambre</option>
                ...
                <select name="nb_salle_bain" id="" class="form-control shadow-none">
                    <option value="-1">Selectionner Nombre De Salle De Bain</option>
                    <option value="0">1</option>
                    <option value="1">2</option>
                    <option value="2">3</option>
                </select>
                <select name="nb_sallon" id="" class="form-control shadow-none">
                    <option value="0">Selectionner Nombre De Sallon</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
                </select>
                <input type="number" name="surface" class="form-control shadow-none" placeholder="Surface" required>
                <input type="number" name="etage" class="form-control shadow-none" placeholder="Etage" required>
