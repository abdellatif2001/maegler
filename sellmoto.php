...
if(isset($_SESSION['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $likes = 0;
        // insert the data
        $Data->moto_reviews($title,$descrip,$price,$ann_mod,$klm,$cyln,$nb_well,$origine,$pr_main,$etat,$id,$image,$location,$likes,$status);
    ...
    <div class="container">
        <div class="appart-info">
            ...
            <form action="" method="post" enctype='multipart/form-data'>
                ...
                <select name="ann_mod" class="form-control shadow-none">
                ...
                <input type="number" name="cyln" class="form-control shadow-none" placeholder="Cylindre cm3" required>
                <select name="nb_well" id="" class="form-control shadow-none">
                    <option value="0">Nombre De Roues</option>
