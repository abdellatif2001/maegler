<?php
    ...
    if (isset($_GET['id'])) {
      ...
      # code...
      $row = $Data->category('maison','idmaison',$id);
          ...
          <div class="article">
              ...
              <div class="img-gallery">
                  ...
                  <div class="prod-content">
                    ...
                    <table class="table table-light">
                      ...
                      <tr>
                        <td class="text-capitalize">nombre de chambre</th>
                        <td class="text-capitalize text-right"><?=$row['nb_chambre']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize"><?=$row['nb_salle_bain']?></th>
                        <td class="text-capitalize text-right"><?=$row['nb_salle_bain']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">nombre de sallon</th>
                        <td class="text-capitalize text-right"><?=$row['nb_sallon']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">surface</th>
                        <td class="text-capitalize text-right"><?=$row['surface']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">nombre d'étage</th>
                        <td class="text-capitalize text-right"><?=$row['nb_etage']?></td>
                      </tr>
                    </table>
              ...
              <div class="seller">
                ...
                <div class="seller-contact">
                  <a href="wa.me/https://wa.me/<?=$user['number']?>" class="btn btn-success text-capitalize"><i class="fa-brands fa-whatsapp"></i> &nbsp; whatsapp</a>
