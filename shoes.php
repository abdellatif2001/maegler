<?php
    ...
    if (isset($_GET['id'])) {
      ...
      # code...
      $row = $Data->category('shoes','idshoes',$id);
              ...
              <div class="img-gallery">
                  ...
                  <div class="prod-content">
                    ...
                    <table class="table table-light">
                      ...
                      <tr>
                        <td class="text-capitalize">taille</th>
                        <td class="text-capitalize text-right"><?=$row['taille']?></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">genre</th>
                        <td class="text-capitalize text-right"><?=$row['gender']?></td>
                      </tr>
                    </table>
