<?php
    ...
    if (isset($_GET['id'])) {
      ...
      # code...
      $row = $Data->category('appartement','idappartement',$id);
              ...
              <div class="img-gallery">
                  ...
                  <div class="prod-content">
                    ...
                    <table class="table table-light">
                      ...
                      <tr>
                        <td class="text-capitalize">nombre de salle de bain</th>
                      ...
                      <tr>
                        ...
                        <td class="text-capitalize text-right"><?=$row['surface']?> m <sup>2</sup></td>
                      </tr>
                      <tr>
                        <td class="text-capitalize">étage</th>
                        <td class="text-capitalize text-right"><?=$row['etage']?></td>
                      </tr>
                    </table>
